...
const LoseScreen = () => {
  ...
  useEffect(() => {
    console.log('appear', playerHealth);
    if (playerHealth <= 0) {
  ...
  return (
    <>
      <div
        className='absolute inset-0 z-50 bg-amber-400 mix-blend-hue select-none pointer-events-none'
        ref={hueRef}
      ></div>
      <div
      ...
      >
        ...
        >
          <h1
            ...
            style={{
              textShadow: '0px 10px 0 #ffb90020',
            }}
          >
            YOU LOSE!
          </h1>
        ...
        <div className='w-[30vh] h-[9vh] absolute bottom-[12vh] left-[12vw] flex justify-center items-center text-amber-400 hover:text-white hover:scale-105 transition-all duration-300 ease-out text-2xl font-bold bg-[url(/button-background-left.svg)] bg-no-repeat bg-contain bg-center'>
          Restart Game
        </div>
        <div className='w-[31.5vh] h-[9vh] absolute bottom-[12vh] right-[12vw] flex justify-center items-center text-amber-400 hover:text-white hover:scale-105 transition-all duration-300 ease-out text-2xl font-bold bg-[url(/button-background-right.svg)] bg-no-repeat bg-contain bg-center'>
          Main menu
        </div>
      </div>
    </>
